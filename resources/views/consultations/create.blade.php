    ...
    <div class="py-12">
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white rounded-2xl border border-gray-100 p-8">
                ...
                <div class="mb-8">
                    <h3 class="text-lg font-bold text-gray-900 mb-2">Informasi Bisnis Anda</h3>
                    <p class="text-gray-600">Isi formulir di bawah untuk mendaftar konsultasi gratis dengan konsultan ahli PLUT.</p>
                </div>
                ...
                <form action="{{ route('consultations.store') }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input id="nama_umkm" name="nama_umkm" type="text" 
                            ...
                            placeholder="Contoh: Toko Kue Alami" 
                    ...
                    <div>
                        ...
                        <select id="bidang_usaha" name="bidang_usaha" 
                            ...
                            <option value="Kuliner" {{ old('bidang_usaha') == 'Kuliner' ? 'selected' : '' }}>🍽️ Kuliner</option>
                            <option value="Fashion" {{ old('bidang_usaha') == 'Fashion' ? 'selected' : '' }}>👕 Fashion</option>
                            <option value="Kriya" {{ old('bidang_usaha') == 'Kriya' ? 'selected' : '' }}>🎨 Kriya / Kerajinan</option>
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-sm text-gray-600">
                            ...
                            Konsultan akan menghubungi Anda melalui WhatsApp
                        </p>
                        @error('nomor_wa')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <textarea id="keluhan_utama" name="keluhan_utama" rows="5" 
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent @error('keluhan_utama') border-red-500 @enderror" 
                            placeholder="Jelaskan masalah atau topik yang ingin Anda konsultasikan dengan detail..." required>{{ old('keluhan_utama') }}</textarea>
                        <p class="mt-2 text-sm text-gray-600">
                ...
                <div class="mt-8 pt-8 border-t border-gray-100">
                    <div class="bg-indigo-50 rounded-xl p-6 border border-indigo-100">
                        ...
                        <ol class="space-y-2 text-sm text-gray-700">
                            <li><strong>1.</strong> Formulir Anda akan kami terima</li>
                            <li><strong>2.</strong> Tim PLUT akan menghubungi Anda via WhatsApp dalam 1x24 jam</li>
                            <li><strong>3.</strong> Konsultasi dilakukan secara gratis sesuai jadwal yang disepakati</li>
                            <li><strong>4.</strong> Anda akan mendapatkan rekomendasi dan solusi untuk bisnis Anda</li>
                        </ol>
                    </div>
                </div>
